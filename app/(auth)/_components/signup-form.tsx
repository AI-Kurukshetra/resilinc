...
export function SignupForm({ nextPath }: SignupFormProps) {
  ...
  const payload = useMemo(
    () => ({ email, password, confirmPassword, next: nextPath }),
    [email, password, confirmPassword, nextPath],
  );
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response = await postAuth<SignupResponse>("/api/auth/signup", parsed.data);
